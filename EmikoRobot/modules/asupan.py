...
async def _(event):
    ...
    try:
        asupannya = [
            asupan
            async for asupan in ubot2.iter_messages(
            "@GUDANGDESAH", filter=InputMessagesFilterVoice
            )
        ]
        kontols = random.choice(asupannya)
        pantek = await ubot2.download_media(kontols)
...
async def _(event):
    ...
    try:
        asupannya = [
            asupan
            async for asupan in ubot2.iter_messages(
            "@+6zcXP8nKYxFhMGUx", filter=InputMessagesFilterVideo
            )
        ]
        kontols = random.choice(asupannya)
        pantek = await ubot2.download_media(kontols)
...
async def _(event):
    ...
    try:
        asupannya = [
            asupan
            async for asupan in ubot2.iter_messages(
            "@GUDANGLUCU", filter=InputMessagesFilterVideo
            )
        ]
        kontols = random.choice(asupannya)
        pantek = await ubot2.download_media(kontols)
...
async def _(event):
    ...
    try:
        ...
        await tbot.send_file(
            event.chat.id, 
            caption="Meme ID by Hancock Robot", 
            file=pantek
            )
        await memeks.delete()
    except Exception:
...
async def _(event):
    ...
    try:
        asupannya = [
            asupan
            async for asupan in ubot2.iter_messages(
            "@gudangpaphancock", filter=InputMessagesFilterPhotos
            )
        ]
        kontols = random.choice(asupannya)
        pantek = await ubot2.download_media(kontols)
